...
v8 扩展 `outcomes`：`realized_net_pct`、`benchmark_pct`、`alpha_pct` 与 `fees_quote` 可为 NULL 表示未知；
...
3. R5 真实调用前由负责人显式确定 `dailyBudgetUsd`/`dailyTokenCap` 与实验总额度，并配置不与 production/其他进程
